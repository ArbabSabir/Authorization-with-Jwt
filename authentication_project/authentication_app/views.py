...
class LoginAPIView(APIView):
    def post(self, request):
        ...
        if user:
            ...
            list_data = {"success" : True, "message":"User login successfully", "code":"Login_API", "data":user_serializer.data}
            return Response(list_data,headers={'token': str(token.access_token)},status=status.HTTP_200_OK)
